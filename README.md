...
<br />
<div align="center">
  <a href="https://github.com/jbrada/module-admin-order-product-links">
...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/jbrada/module-admin-order-product-links"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/jbrada/module-admin-order-product-links">View Demo</a>
    ·
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `jbrada`, `module-admin-order-product-links`, `twitter_handle`, `linkedin_username`, `email`, `email_client`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/jbrada/module-admin-order-product-links.git
   ```
...
See the [open issues](https://github.com/jbrada/module-admin-order-product-links/issues) for a full list of proposed features (and known issues).
...
[license-url]: https://github.com/jbrada/module-admin-order-product-links/blob/master/LICENSE.txt
